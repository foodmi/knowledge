...
- [x] App Flutter complete (30 langues, scan IA, dashboard, assistant, sante, gamification)
...
- [x] Monetisation RevenueCat integree
- [x] Onboarding conversationnel 41 etapes
- [x] Support RTL arabe
...
- [ ] 6 screenshots (3 tailles iOS + 1 Play)
- [ ] Feature Graphic Google Play (1024x500)
- [ ] 4 Custom Store Listings (Scanner, Weight Loss, Macro, Halal)
- [ ] Localiser store en 5 langues min (FR, EN, AR, ES, DE)
